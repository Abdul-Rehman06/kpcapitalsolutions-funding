...
export function NotFoundPage() {
  ...
  return (
    <section className="bg-white font-serif min-h-[calc(100vh-120px)] flex items-center justify-center">
          ...
          <div className="w-full sm:w-10/12 md:w-8/12 text-center">
            ...
            <div className="mt-[-50px]">
              ...
              <Button
                variant="default"
                onClick={() => navigate("/")}
                className="my-5 bg-gold-500 hover:bg-gold-400 text-white rounded-none py-6 px-8 text-sm font-bold uppercase tracking-widest"
              >
                Go to Home
              </Button>
            </div>
